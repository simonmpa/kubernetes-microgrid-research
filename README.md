...
Here the results of the simulation for each microgrid is stored in a separate log file, and can be evaluated against our results in `python-microgrid-simulation/results`.
